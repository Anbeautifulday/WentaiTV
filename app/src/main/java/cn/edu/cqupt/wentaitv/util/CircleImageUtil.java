...
public class CircleImageUtil extends ImageView {
    ...
    public CircleImageUtil(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs,
                R.styleable.CircleImageUtil);
        // 边界的宽度
        mBorderThickness = a.getDimensionPixelSize(
                R.styleable.CircleImageUtil_border_thickness, 0);
        // 外边界的颜色
        mBorderOutsideColor = a.getColor(
                R.styleable.CircleImageUtil_border_outside_color, defaultColor);
        // 内边界的颜色
        mBorderInsideColor = a.getColor(
                R.styleable.CircleImageUtil_border_inside_color, defaultColor);
    }
